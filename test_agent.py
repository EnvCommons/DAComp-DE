"""End-to-end agent test for DAComp DE with rollout logging to OpenReward."""
...
async def main():
    ...
    MODEL_NAME = "gpt-5.2"
    ENV_NAME = "GeneralReasoning/DAComp-DE"
    SPLIT = "test"
